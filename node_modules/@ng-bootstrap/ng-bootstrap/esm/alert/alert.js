...
import { Component, Directive, Input, Output, EventEmitter, ChangeDetectionStrategy, ViewContainerRef, Injector, ComponentFactoryResolver, TemplateRef } from '@angular/core';
...
export let NgbDismissibleAlert = class NgbDismissibleAlert {
    constructor(_templateRef, _viewContainerRef, _injector, componentFactoryResolver) {
...
NgbDismissibleAlert = __decorate([
    ...
    __metadata('design:paramtypes', [TemplateRef, ViewContainerRef, Injector, ComponentFactoryResolver])
], NgbDismissibleAlert);
